# Global Resiliency/Disaster Recovery Streams - DEPRECATED AS OF VERSION 2.16.0

** Please refer to [Documentation-GR.md](Documentation-GR.md) for new ACGR documentation **
